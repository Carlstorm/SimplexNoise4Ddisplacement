export default function StopIcon({onClick, className}) {
    return (
        <svg className={className} version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" onClick={onClick}>
            <defs>
                ...
                <stop offset="40%" style={{stopColor: "#80008b", stopOpacity: 1}} />
                <stop offset="60%" style={{stopColor: "#80008b", stopOpacity: 1}} />
            ...
            <rect x="176" y="176" width="160" height="160" fill="url(#grad1)"/>
        </svg>
    )
}